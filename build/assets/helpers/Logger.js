...
class Logger {
    ...
    logo() {
        console.log(chalk_1.default.black("-------------------------------------------------------------------------------------------------------------------\n"), chalk_1.default.blueBright(" █████╗  ██████╗███████╗  "), chalk_1.default.white("   ███████╗███████╗██████╗ ██╗   ██╗██╗ ██████╗███████╗███████╗\n"), chalk_1.default.blueBright("██╔══██╗██╔════╝██╔════╝  "), chalk_1.default.white("   ██╔════╝██╔════╝██╔══██╗██║   ██║██║██╔════╝██╔════╝██╔════╝\n"), chalk_1.default.blueBright("███████║██║     █████╗    "), chalk_1.default.white("   ███████╗█████╗  ██████╔╝██║   ██║██║██║     █████╗  ███████╗\n"), chalk_1.default.blueBright("██╔══██║██║     ██╔══╝    "), chalk_1.default.white("   ╚════██║██╔══╝  ██╔══██╗╚██╗ ██╔╝██║██║     ██╔══╝  ╚════██║\n"), chalk_1.default.blueBright("██║  ██║╚██████╗███████╗  "), chalk_1.default.white("   ███████║███████╗██║  ██║ ╚████╔╝ ██║╚██████╗███████╗███████║\n"), chalk_1.default.blueBright("╚═╝  ╚═╝ ╚═════╝╚══════╝  "), chalk_1.default.white("   ╚══════╝╚══════╝╚═╝  ╚═╝  ╚═══╝  ╚═╝ ╚═════╝╚══════╝╚══════╝\n"), chalk_1.default.gray("\n[»] "), chalk_1.default.bold("Ace Services Server Bot V1"), chalk_1.default.gray("\n[»] "), chalk_1.default.bold(`Config contents validated`), chalk_1.default.gray("\n[»] "), chalk_1.default.bold("Developer: Bacio"), chalk_1.default.gray("\n[»] "), chalk_1.default.bold("https://discord.gg/Rgkgmtvzv5\n"));
    }
}
