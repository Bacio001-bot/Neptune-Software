...
class GiveawayRerollCommand extends Command_1.default {
    constructor(client) {
        super(client, {
            name: "giveawayreroll",
            description: "Reroll a giveaway",
            arguments: "<giveawayid>",
            example: "/giveawayreroll 123456?",
            category: "giveaway",
            type: "discord",
            deleteMessage: true,
            cooldown: true,
    ...
    async execute(message, args) {
        ...
        try {
            ...
            let giveaway2Embed = new discord_js_1.MessageEmbed()
                .setTitle(`Giveaway ended (Reroll)`)
            ...
            if (giveawayMessage && (result === null || result === void 0 ? void 0 : result.active)) {
                ...
                return this.messages.success("Giveaway Rerolled", `Giveaway with the id \`#${args[0]}\` has been rerolled`, message);
            }
            else {
...
exports.default = GiveawayRerollCommand;
